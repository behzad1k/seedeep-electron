...
import { Camera, BackendCamera, BackendDetection, BackendModelResult, BackendTrackingResult, BackendWebSocketResponse } from '@shared/types';
import { MODEL_NAME_MAP, BACKEND_MODEL_MAP } from '@core/config/backend';
